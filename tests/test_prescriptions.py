...
def test_validate_prescriptions_valid():
    assert prescriptions.validatePrescriptionData({
        "clinic": {"id": 123},
        "physician": {"id": 123},
        "patient": {"id": 123},
        "text": "validText"
...
def test_validate_prescriptions_invalid_text():
    assert not prescriptions.validatePrescriptionData({
        "physician": {"id": 123},
        "patient": {"id": 123}
    })
...
def test_save_prescription_with_clinic_name():
    ...
    mock_database.return_value.prescriptions.insert_one.return_value = MagicMock(inserted_id=1)
    mock_database.return_value.prescriptions.find_one.return_value = MagicMock()
